...
public class Inverders : MonoBehaviour
{
    [Header("Invaders")]
    public Inverder[] prefabs = new Inverder[5];
    public AnimationCurve speed = new AnimationCurve();
    public Vector3 direction { get; private set; } = Vector3.right;
    public Vector3 initialPosition { get; private set; }
    public System.Action<Inverder> killed;
    ...
    [Header("Missiles")]
    public projectily missilePrefab;
    ...
    private void Awake()
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            ...
            for (int j = 0; j < columns; j++)
            {
                ...
                Inverder invader = Instantiate(prefabs[i], transform);
    ...
    private void OnInvaderKilled(Inverder invader)
    {
